  ...
  return (
    <header className="flex items-end justify-between gap-4 py-4 md:py-6">
      <NavLink to="/" className="group flex flex-col">
        <span className="inline-flex items-center gap-1 font-serif text-lg font-medium tracking-tight md:text-xl group-hover:text-ink/75">
        mockingboard
        <svg
        ...
        <span className="font-mono text-[0.6em] tracking-tighter text-ink-muted/80">
          by floating.is
        </span>
      </NavLink>
