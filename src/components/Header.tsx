    ...
    <header className="flex items-center justify-between gap-4 py-4 md:py-6">
      <div className="inline-flex flex-col">
        ...
        >
          ...
          <path d="M15.47.5c.6,0,1.2.3,1.6.8l3,4c.5.7.5,1.7,0,2.4l-8,11c-1.7,2-1.81,1.7-2.79.48-.6-.75-.66-.8-.82-1.05L.88,7.7c-.5-.7-.5-1.7,0-2.4L3.88,1.3c.4-.5,1-.8,1.6-.8h10Z" stroke-width="1"/>
          <path d="M.47,6.5h20"/>
